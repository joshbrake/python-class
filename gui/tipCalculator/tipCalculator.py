...
class tipCalculator(Tkinter.Tk):
  ...
  def initialize(self):
    ...
    # Meal subtotal label
    self.subtotalLabel = Tkinter.Label(self,text='Subtotal ($)',anchor='w',fg='black')
    ...
    self.tipPercentageLabel = Tkinter.Label(self,text='Tip Percentage (%)',anchor='w',fg='black')
    ...
    self.tipLabel = Tkinter.Label(self,textvariable=self.tipLabelVariable,anchor='w',fg='black')
    ...
    self.totalLabel = Tkinter.Label(self,textvariable=self.totalLabelVariable,anchor='w',fg='black')
